...
function WelcomePage(props: {
  ...
  const pageCover = (
    <div className="absolute bg-orange-200 w-[87.5%] h-[91.5%] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"/>
  );

  const greetingCard = (
    <div className="flex flex-col bg-yellow-50 drop-shadow-md absolute w-[51%] h-[28%] left-[2.5%] top-[11%] px-8 py-14 rotate-1 rounded-sm">
  ...
  const aboutMeCard = (
    <div className="flex flex-col absolute bg-yellow-50 w-[40%] h-[28%] left-[57%] top-[38%] p-4 drop-shadow-md rounded-sm">
      <RoughNotationGroup show={animation}>
  ...
  const backgroundTextCard = (
    <div className="absolute bg-yellow-50 w-[60%] h-[28%] left-[33%] top-[64%] drop-shadow-md p-4 text-xs rounded-sm">
  ...
  const quoteCard = (
    <div className="absolute bg-yellow-50 drop-shadow-md w-[43%] h-[15%] left-[7%] top-[80%] p-4 text-sm flex flex-col rounded-sm">
  ...
  const skylineImage = (
    <div className="absolute w-[42%] h-[36.4%] left-[54%] top-[5%] -rotate-1 drop-shadow-md rounded-sm">
      <Image src="/atlanta-skyline-photo.png" alt="sample" fill/>
    </div>
  );

  const beachImage = (
    <div className="absolute w-[45%] h-[38%] left-[25%] top-[50%] rotate-3 drop-shadow-md rounded-sm">
